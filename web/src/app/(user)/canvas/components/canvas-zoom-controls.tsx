        ...
        <div className="absolute bottom-5 left-5 z-50" onMouseDown={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()}>
            <div className="flex h-14 items-center gap-1 rounded-xl border px-2 shadow-lg backdrop-blur" style={dockStyle}>
                <Tooltip>
                    ...
                    <TooltipContent>{isMiniMapOpen ? "关闭小地图" : "打开小地图"}</TooltipContent>
                </Tooltip>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="ghost" className="!h-8 !w-8 !min-w-8 !p-0" style={{ color: theme.toolbar.item }} onClick={onReset} aria-label="重置视图">
                ...
                <Tooltip>
                    ...
                    <TooltipContent>放大/缩小画布</TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="ghost" className="!h-8 !w-8 !min-w-8 !p-0" style={shortcutsOpen ? activeStyle : { color: theme.toolbar.item }} onClick={() => setShortcutsOpen(true)} aria-label="快捷键">
